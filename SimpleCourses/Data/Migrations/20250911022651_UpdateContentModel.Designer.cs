...
namespace SimpleCourses.Data.Migrations
{
    ...
    [Migration("20250911022651_UpdateContentModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleCourses.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SimpleCourses.Models.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SimpleCourses.Models.Entities.CategoryItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SimpleCourses.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SimpleCourses.Models.Entities.CategoryItem", b =>
                {
                    b.HasOne("SimpleCourses.Models.Entities.Category", null)
